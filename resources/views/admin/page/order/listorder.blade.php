        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Danh sách đơn hàng chưa chốt</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb p-0 m-0">
                            <li class="breadcrumb-item"><a href="{{route('admin.home')}}">Trang chủ</a></li>
                            <li class="breadcrumb-item active">Đơn hàng chưa chốt</li>
                        </ol>
                    </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <?php if ($ct->status == 0): ?>
                                        <td class="text-danger"> <i class="ion ion-ios-alert text-danger"></i> Chưa chốt đơn</td>
                                    <?php endif ?>
                                </tr>
                                @endforeach
                            </tbody>
...
@endsection
@section('title')
    <title>Đơn hàng chưa chốt - Phụ kiện máy tính Hoàng Tú</title>
@endsection